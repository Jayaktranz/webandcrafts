                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.orders.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="customer_fname" type="text" class="form-control @error('customer_fname') is-invalid @enderror" name="customer_fname" value="{{ old('customer_fname') }}" required autocomplete="customer_fname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="customer_lname" type="text" class="form-control @error('customer_lname') is-invalid @enderror" name="customer_lname" value="{{ old('customer_lname') }}" required autocomplete="customer_lname" autofocus>
